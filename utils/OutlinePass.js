...
class OutlinePass extends Pass {
	...
	constructor( resolution, scene, camera, selectedObjects ) {
		...
		this.hiddenEdgeColor = new Color( 0.1, 0.5, 0.6 );
		this.edgeGlow = 3.0;
	...
	changeVisibilityOfSelectedObjects( bVisible ) {
		...
		function gatherSelectedMeshesCallBack( object ) {
			...
			if ( object.isMesh ) {
				if (object.layers.isEnabled(idleLayer)) {
					console.log("cant change vis of idle non-selected object");
					return;
				}
	...
	changeVisibilityOfNonSelectedObjects( bVisible ) {
		...
		function gatherSelectedMeshesCallBack( object ) {
			if (object.layers.isEnabled(idleLayer)) {
					console.log("idle non-selected object");
					return;
				}
		...
		function VisibilityChangeCallBack( object ) {
			...
			if ( object.isMesh || object.isSprite || object.isLine ) {
				...
				if (object.layers.isEnabled(idleLayer)) return;
